function nominalDepth = calculateNominalDepth(siteDepth, instrumentZ, depthStr)
%CALCULATENOMINALDEPTH Calculate nominal depth using depth datum string.
%
% Inputs:
...
switch depthStr
    case {'ASB', 'FROM BOTTOM', 'DISTANCE FROM BOTTOM', 'DEPTH FROM THE SEA BED', 'DEPTH FROM SEABED', 'HEIGHT ABOVE BOTTOM'}
        nominalDepth = siteDepth - instrumentZ;
        
    case {'BSL', 'FROM SURFACE'}
        nominalDepth = instrumentZ;
