...
% https://github.com/aodn/imos-toolbox/issues/657
defaultStr = ['Any users of IMOS data are required to clearly acknowledge the source ',...
    ...
    'Research Infrastructure Strategy (NCRIS). It is operated by a consortium of institutions ',...
    'as an unincorporated joint venture, with the University of Tasmania as Lead Agent." If ',...
    'relevant, also credit other organisations involved in collection of this particular ',...
