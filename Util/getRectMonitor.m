...
switch computer
    case {'PCWIN', 'PCWIN64'}
        % Original code below no longer seems valid
        ...
        % Width and height of displays, returned as an n-by-4 matrix, where n is the
        % number of displays. Each row corresponds to one display and is a
        % four-element vector of the form [x y width height]. For example, if there are two displays, then the matrix has this form:
        %
        ...
        % make final plot widths/heights 5% smaller
        wf = 0.05 * wm;
        hf = 0.05 * hm;
