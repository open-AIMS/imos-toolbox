...
if isfield(waveData, 'SpectraType')
    vars = {
        ...
        ['WPDI' magExt],      1,       waveData.PeakDirection; ...          % Peak direction (DirTp) (deg). This is the direction of the wave corresponding to the peak period. The direction is reported as â€œfromâ€? and is reported in degrees.
        ...
        ['VDIR' magExt],      1,       waveData.MeanDirection; ...          % Mean direction (Mdir) (deg). This value is a weighted average of all the directions in the wave spectrum. It is weighted according to the energy at each frequency. The direction is reported as â€œfromâ€? and is reported in degrees.
        'TEMP',               1,       waveData.Temperature; ...
        'PRES_REL',           1,       waveData.MeanPressure; ...           % Mean Pressure (dbar).
        'BAT_VOLT',           1,       waveData.Battery; ...
