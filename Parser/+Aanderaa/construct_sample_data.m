function sample_data = construct_sample_data( deviceInfo, data, xattrs, mode )
%construct_sam create sample_data struct
%
% Inputs:
...
sample_data = struct;
sample_data.toolbox_input_file  = deviceInfo.toolbox_input_file;
