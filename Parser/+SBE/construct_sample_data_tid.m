function sample_data = construct_sample_data_tid( header, data, xattrs, mode )
...
sample_data = struct;
sample_data.toolbox_input_file  = header.tid_filename;
...
if isfield(header, 'instrument_burst_duration')
    meta.instrument_burst_duration = header.instrument_burst_duration;
end
