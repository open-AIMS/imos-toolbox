...
Usage:
  build)aims.py  --arch=<architecture> [--root_path=<imostoolboxpath> --mcc_path=<mccpath> --mat_path=<matpath> --dist_path=<distpath>]

Options:
  -h --help     Show this screen.
  --version     Show version.
  --mcc_path=<mccpath>           The Matlab runtime Path
  --mat_path=<matpath>           The Matlab executalbe full path
...
def create_mcc_call_sig(mat_path: str, mcc_path: str, root_path: str, dist_path: str,
    ...
    if arch == 'win64':
        ...
        external_call = f"\"{mat_path}\" -nodesktop -nosplash -wait -r \"run('{tmpscript}');exit\""
...
def get_args(args: dict) -> (str, str, str, str, str):
    ...
    return root_path, dist_path, mcc_path, mat_path, arch
...
if __name__ == '__main__':
    ...
    root_path, dist_path, mcc_path, mat_path, arch = get_args(args)
    ...
    mcc_call = create_mcc_call_sig(mat_path, mcc_path, root_path, dist_path, mfiles,
