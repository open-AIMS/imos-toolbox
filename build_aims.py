...
Usage:
  build_AIMS.py  --arch=<architecture> [--root_path=<imostoolboxpath> --mcc_path=<mccpath> --mat_path=<matpath> --dist_path=<distpath>]

Options:
  -h --help     Show this screen.
  --version     Show version.
  --mcc_path=<mccpath>           The Matlab runtime Path
  --mat_path=<matpath>           The Matlab executable full path
...
def create_mcc_call_sig(
    ...
    if arch == "win64":
        ...
        external_call = (
            f"\"{mat_path}\" -nodesktop -nosplash -wait -r \"run('{tmpscript}');exit\""
        )
...
# TODO: make a state machine class for this mess.
